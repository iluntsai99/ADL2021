...
class SeqClassifier(torch.nn.Module):
    def __init__(
        ...
        self.lstm = nn.LSTM(embeddings.size(1), hidden_size, num_layers, batch_first=True, bidirectional=bidirectional)
    ...
    def forward(self, batch) -> Dict[str, torch.Tensor]:
        ...
        x, _ = self.lstm(inputs, None)  # x 的 dimension (batch, seq_len, hidden_size)
